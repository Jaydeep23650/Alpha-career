    ...
    <>
        ...
        <main className="flex flex-col items-center justify-center px-8 py-20 mt-10">
          <div className="text-center max-w-3xl">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Discover exciting career opportunities at leading companies. Join
              thousands of professionals in finding their perfect match.
            </p>
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <button
                className="px-8 py-3 bg-white text-gray-900 font-medium rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-2 border border-gray-200"
                onClick={handleClick}
              >
                Admin Portal
                <svg
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 ">
                Explore open positions from top companies in your field.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <div className="w-16 h-16 bg-yellow-100 rounded-lg flex items-center justify-center mb-6"></div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">
                Get Hired
              </h3>
              <p className="text-gray-600">
                Land your dream job and start your new career.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-blue-600 py-20 px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button
            className="px-8 py-4 bg-white text-blue-600 font-medium rounded-lg hover:bg-gray-100 transition-colors flex items-center gap-2 mx-auto"
            onClick={() => router.push("/jobs")}
          >
            View All Jobs
          </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    href="https://www.alphanodus.com/about"
